...
router.post('/:id/view', obituaries.trackObituaryView as unknown as RequestHandler)
router.post('/:id/like', requireAuth as unknown as RequestHandler, obituaries.likeObituary as unknown as RequestHandler)
